...
There is also a perspective on LSMs as a data structure that lets you kind of interpolate between two other data structures at the extreme of read and write amplification, which is discussed in the Monkey paper \cite{2017monkey}. Basically, with a pure append-only log at the one extreme (write optimized), and a sorted array at the other extreme (read optimized).
