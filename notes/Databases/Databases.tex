...
LSM Trees \cite{1996lsmtree} is a persistent data structure that is optimized for writes. Essentially, it is serving the same purpose as a B-tree or hash map i.e. storing a key-value map, but is designed to optimize for write performance.
