...
\end{center}
In practice, I don't think it's that important to worry too much about the finer points of what distinguishes these different logics, since typically I am more concerned with how to express a desired correctness property (e.g. for which LTL is often sufficient). Nevertheless it is good to have a general view of the classification hierarchy to understand the landscape (and since various papers may choose to express/formalize things in different choices of logics).
